...
A **uTools plugin** that converts Java `toString()` output strings into JSON format. uTools is an Electron-based
productivity launcher (Chinese ecosystem). The plugin is triggered by keyword "Java转JSON" and accepts text input.
